...
import { AnyGameData, GameDataUnfilledRowIndices, GetNextToMove } from './Game'
...
> = {
  [key in `place${Key}`]: {
    [I in GameDataUnfilledRowIndices<GD>]: MoveInterfaceRow<I, M, GD>
  }
}

export type MoveInterfaceRow<
  I extends RowIdx,
  M extends X | O,
  GD extends AnyGameData
> =
  { [J in RowFreeSpace<GD['board'][I]>]:
      InterpretAction<PlaceMarkAction<M, I, J>, GD>
  }
